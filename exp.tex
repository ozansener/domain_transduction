...
\vspace{2mm}
\noindent \textbf{Evaluation:} We evaluate all algorithms in a \emph{fully transductive} setup.  We feed training images and labels of the first domain as the source and training images of the second domain as the target. We evaluate the accuracy on the target domain as the ratio of correctly labeled images to all target images.
