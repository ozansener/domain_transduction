...
\begin{figure}[ht]
    \subfigure[S. w/o Adaptation]{\includegraphics[width=0.25\textwidth]{before_c_s_c}}~
    \subfigure[S. with Adaptation]{\includegraphics[width=0.25\textwidth]{after_c_s_c}}~
    \subfigure[T w/o Adaptation]{\includegraphics[width=0.25\textwidth]{before_c_t_c}}~
    \subfigure[T with Adaptation]{\includegraphics[width=0.25\textwidth]{after_c_t_c}}
