...
\caption{Example nearest neighbors for Amazon$\rightarrow$Webcam experiment. We show an example webcam image and 5-NN Amazon images. The drop of the accuracy after a few nearest neighbors is expected since our loss function only depends on the nearest examples.}
\label{fig:nnoffice}
\end{figure}
